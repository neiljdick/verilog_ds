...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+4,0,"counter",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    ...
    tracep->pushPrefix("hello_world", VerilatedTracePrefixType::SCOPE_MODULE);
    ...
    tracep->declBit(c+8,0,"enable",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+9,0,"counter",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+4,(vlSelf->counter),8);
    bufp->fullBit(oldp+5,(vlSelf->overflow));
    bufp->fullBit(oldp+6,(vlSelf->hello_world__DOT__clk));
    bufp->fullBit(oldp+7,(vlSelf->hello_world__DOT__rst_n));
    bufp->fullBit(oldp+8,(vlSelf->hello_world__DOT__enable));
    bufp->fullCData(oldp+9,(vlSelf->hello_world__DOT__counter),8);
    bufp->fullBit(oldp+10,(vlSelf->hello_world__DOT__overflow));
}
